...
public class BallControl : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        if (canShoot)                                               //if canSHoot is true
        {
            ...
            GolfUIManager.instance.PowerBar.fillAmount = 0;             //reset the powerBar to zero
    ...
    public void MouseNormalMethod()                                         //method called by InputManager
    {
        ...
        GolfUIManager.instance.PowerBar.fillAmount = force / MaxForce;              //set the powerBar image fill amount
